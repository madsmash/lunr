...
class SessionDAOTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->query_result = $this->getMock('Lunr\DataAccess\DatabaseQueryResultInterface');
    ...
    public function testReadSessionDataReturnsFalseIfSessionNotExists()
    {
        ...
        $this->query_builder->expects($this->once())
                 ->method('from');
        //         $this->query_builder->expects($this->at(0))
        //                  ->method('column')
        //                  ->with($this->equalTo('sessionID'));
        //         $this->query_builder->expects($this->at(1))
        //                  ->method('column')
        //                  ->with($this->equalTo('expires'));
        //I believe this is an issue with phpunit, the line below works, the ones above don't
